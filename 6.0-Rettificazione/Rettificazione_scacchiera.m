...
% risulteranno parallele e orizzontali. Teoria vedi lezione 10 blocco note 
...
%le nuove matrice sono una rotazione dalla matrice di partenza intorno ad
%optical center

%devo spostare i punti:
Rc_left = rodrigues(stereo.omc_left_1); % 	Transform rotation matrix into rotation vector and viceversa.
...
% Ottendo i centri ottici delle due camere C=-inv(Q1)*q (visto a lezione)
...
% r1: nuovo asse X, dovrè essere parallelo alla linea di base e fin qui ci
% siamo
v1 = (c2-c1);
% Pongo un versore uguale alla vecchia asse Z, ottimo
k=R1(3,:);
...
% Normalizzo e compongo R quella che volevo trovare, ora posso fare nuove
% matrici
