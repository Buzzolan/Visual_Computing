...
% versione vecchia, senza raffinamento iterativo, vedi lezione
% triangolazione
       ...
       for view = 1:numV
         ...
         A =  [A
          PPM(1,:,view) - m(1,i,view)*PPM(3,:,view)
           PPM(2,:,view) - m(2,i,view)*PPM(3,:,view)];%forumla esatta vista a lezione linear eigen
       end   
    x = ns(A);%last column in SVD
    M =[M x(1:3)./x(4)];%trasformo da omeogeneous a euclidian coordinates
 end
